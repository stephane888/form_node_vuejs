...
class FormNodeVuejsApi extends ControllerBase {
  ...
  public function getTerms($vid, Request $Request)
  { // action
    ...
    // $configs = \Drupal::service('entity_type.manager')->getStorage("taxonomy_term")->loadTree($vid, $parent = 0, $max_depth = NULL, $load_entities = FALSE);
    $configs = $this->TaxonomyTermTree->load($vid);
    $reponse = new JsonResponse();
